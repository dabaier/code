...
def data_set_split(src_data_folder, target_data_folder, train_scale=0.8, val_scale=0.1, test_scale=0.1):
    ...
    for class_name in class_names:
        ...
        print(
            "{}类按照{}：{}：{}的比例划分完成，一共{}篇代码".format(class_name, train_scale, val_scale, test_scale, current_data_length))
        print("训练集{}：{}篇".format(train_folder, train_num))
        print("验证集{}：{}篇".format(val_folder, val_num))
        print("测试集{}：{}篇".format(test_folder, test_num))


if __name__ == '__main__':
    src_data_folder = "E:/graph_embedding/数据处理相关文件/C++DATA"
    target_data_folder = "E:/graph_embedding/数据处理相关文件/Dataset"
