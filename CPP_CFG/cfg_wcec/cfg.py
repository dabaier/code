...
thisdir = os.path.dirname(os.path.abspath(__file__))  #E:\graph_embedding
sys.path.insert(0,  os.path.join(thisdir, 'pycparser'))#新添加的目录会优先于其他目录被import检查，程序退出后失效

from pycparser import parse_file
from . import cfg_ast_visitor
...
class CFG(object):
    ...
    def make_cfg(self):
        ...
        #                       cpp_path='gcc',
        #                       cpp_args=['-E'])
        self._ast = parse_file(self._filename, use_cpp=False)
